  ...
  return new Promise(function(resolve) {
    resolve({
      common: {
        ...
        form_start_day: "What day does it start?",
        form_start_time: "What time does it start?",
        form_end_day: "What day does it end?",
        form_end_time: "What time does it end?",
      ...
      agency: {
        ...
        banner_title: "The 'cloud' made easy!",
        banner_subtitle:
          "Run serverless workloads across cloud and edge with a simple 'git push'!",
